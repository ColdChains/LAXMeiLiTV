...
// 追加
- (void)reloadMainCollectionView {
    int currentIndex = [self currentIndex];
    if (currentIndex) {
        [_mainView scrollToItemAtIndexPath:[NSIndexPath indexPathForItem:2 inSection:0] atScrollPosition:UICollectionViewScrollPositionNone animated:NO];
    }
}
